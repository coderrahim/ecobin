...
const Contact = () => {
    return (
        <div>
            <div className="flex flex-col items-center justify-center bg-[url(https://i.ibb.co/rp86MXS/image.jpg)] bg-cover bg-fixed bg-center bg-no-repeat h-[60vh] mt-16 rounded-2xl">
