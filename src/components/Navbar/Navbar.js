...
const Navbar = () => {
  ...
  return (
    <div>
      <header className="relative z-20 w-full bg-transparent lg:after:absolute lg:after:top-full lg:after:left-0 lg:after:z-10 lg:after:h-px lg:after:w-full lg:after:bg-slate-200 lg:backdrop-blur-sm after:hidden">
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            <div className="ml-auto flex items-center px-6 lg:ml-0 lg:p-0">
              ...
              <Link href={"/login"}>
                <button className='bg-green-600 text-sm text-white font-semibold px-3 py-2 rounded-md hover:scale-105'>Login</button>
              </Link>
              {/*        <!-- End Avatar --> */}
            </div>
          </nav>
