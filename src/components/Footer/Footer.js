...
const Footer = () => {
    return (
        ...
        {/*  <!-- Main footer --> */}
        <div className="pt-16 pb-12 text-sm border-t border-emerald-200 bg-emerald-50">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              ...
              <nav
                className="col-span-2 md:col-span-4 lg:col-span-3"
                aria-labelledby="footer-about-light"
              >
                <h3
                  className="mb-6 text-base font-medium text-emerald-700"
                  id="footer-about-light"
                >
                  About us
                </h3>
                <ul>
        ...
        {/*  <!-- Sub Footer --> */}
        <div className="py-4 text-sm border-t border-emerald-200/90 bg-emerald-100/80">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              <div className="col-span-2 md:col-span-4 lg:col-span-6">
                Copyright 2022 Brand Name
              </div>
              <nav
